...
{
    $customerStmt = "INSERT INTO customer(tax_id, company_name, email, detail, city_id, postal_code, country_code) VALUES
...
else
{
    ...
    detail = :_detail, city_id = :_city_id, postal_code = :_postal_code, country_code = :_country_code WHERE customer.id = :_customerID;";
    $hasCustomerID = true;
}
...
$stmt->bindParam(':_city_id', $customer['city_id'], PDO::PARAM_INT);
